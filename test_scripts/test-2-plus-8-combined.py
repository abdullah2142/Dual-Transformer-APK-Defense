...
#           number.
#
#  SANITY   Three checks run BEFORE the ~45-minute pass, in this order:
#             1. "Resolving checkpoints:"  six paths, ~499 MB each
#             2. "Provenance scan"         each run's own recorded patience,
#                                          best epoch and accuracy
#             3. "PREFLIGHT"               all six scored on 1,500 samples;
#                                          raises if any sits >2pp above the
#                                          pack, which means an OLD checkpoint
#           Leave every weights field BLANK. Hardcoding a path skips the
#           resolver's directory check -- that is how the old
#           saved_models_codebert/ checkpoint slipped through on 2026-08-17.
#
